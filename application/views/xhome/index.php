...
<div class="grid grid-cols-10 xl:pl-20 xl:pr-10 lg:pl-16 lg:pr-6 2xl:pl-40 2xl:pr-32 md:pl-10 md:pr-2 sm:mx-16 sm:pl-14 mx-6 pl-4 lg:mt-14 xl:mt-10 md:mt-16 mt-12 sm:mt-16 items-center py-0 md:py-10">
        ...
        <div class="col-span-12 sm:col-span-12 md:col-start-1 md:col-end-6 xl:col-start-1 xl:col-end-7 lg:col-start-1 lg:col-end-6 mt-[-10px] sm:mt-0">
        ...
        <div class="inline-block col-span-12 mt-14 md:inline-block md:col-start-8 md:col-end-11 xl:col-start-8 xl:col-end-10 lg:col-start-9 lg:col-end-12 lg:scale-110 xl:scale-125 md:mt-0">
            <img src="<?php echo base_url();?>assets/images/sushi_mol.png" class="w-44 m-auto md:m-0 md:w-72" alt="">
        </div>
    </div>
    <!-- bannar -->

    <div class="m-auto relative w-[70%] sm:w-1/2 lg:mt-24 xl:mt-12 md:mt-20 mt-12 sm:mt-16">
    <input id="search_text" name="search" class="outline-none border-gray-300 rounded-2xl text-sm h-10 pl-4 focus:shadow-none placeholder:text-center placeholder:text-gray-500 w-full border-[1px] px-3 py-6 shadow-2xl shadow-red-400/50 duration-200" type="text" placeholder="Search">
...
<div class="grid grid-cols-12 xl:px-20 2xl:px-40 lg:mt-14 xl:mt-10 md:mt-16 mt-12 sm:mt-16 lg:px-16 md:px-20 sm:px-28 px-14">
        ...
        <div class="hidden lg:inline-block lg:col-start-8 lg:col-end-13 xl:col-start-8 xl:col-end-13 xl:mt-4 lg:mt-8">
            <img src="<?php echo base_url();?>assets/imagess/kokoro_sushi_mol.png" alt="">
        </div>
    </div>
    <div class="grid grid-cols-12 xl:px-20 2xl:px-40 mt-20 lg:px-16 md:px-20 md:mt-14 sm:px-28 sm:mt-20 px-14">
        <div class="hidden lg:inline-block xl:scale-125 lg:scale-110 xl:mt-[50px] lg:mt-[100px] xl:col-start-1 xl:col-end-6 lg:col-start-1 lg:col-end-7">
            <img src="<?php echo base_url();?>assets/imagess/food_safe_delivery.png" alt="">
        </div>
