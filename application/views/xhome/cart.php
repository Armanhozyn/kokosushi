    ...
    <div class="col-sm-12 mgb-20" style="margin-top: 50px;">
        ...
        <table class="table table-bordered table-striped">
            ...
            foreach($cart_items as $item): ?>
                <tr>
                    ...
                    <td class=""><input name="product_remove[]" type="checkbox" value="<?php echo $item['rowid'] ?>" ></td>

                    <td><?php echo $item['name'] ?></td>

                    <td><input name="qty[]" type="number" value="<?php echo $item['qty'] ?>" class="input-mini" min="1" max="9999" step="1"></td>
        ...
        <fieldset>
                    ...
                    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="discount-code" placeholder="Enter your coupon here">
                    ...
                    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="gift-voucher" placeholder="Enter your gift voucher here">
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <button type="submit" class="btn btn-primary pull-right" name="checkout" value="checkout">Checkout</button>
                </div>
            </div>
        </fieldset>
        <?php echo form_close(); ?>
