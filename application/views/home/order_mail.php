							...
							<div class="body-text" style="font-family:Helvetica, Arial, sans-serif;font-size:14px;line-height:20px;text-align:left;color:#333333">
								<table border="1" cellpadding="2" width="100%">
									...
									<?php
										$sl++;
									endforeach; ?>
									<?php if ($checkoutInfo['discount'] != "0.00") : ?>
										<tr>
										...
										<tr>
											<td colspan="5" align="right"><strong>Promo
													<?php
													if ($checkoutInfo['payment_method'] == 'Cash On Delivery') {
														echo  '5%';
													} else {
														echo  '10%';
													}
											...
											<td><strong>-€
													...
													if ($checkoutInfo['payment_method'] == 'Cash On Delivery') {
														...
														echo $this->cart->total() - ($this->cart->total() - $this->cart->total() * 0.05);
													} else {
														echo $this->cart->total() - ($this->cart->total() - $this->cart->total() * 0.1);
													}
													?>
												</strong></td>
									...
									<tr>
										...
										<td><strong>€
												<?php
												if ($checkoutInfo['payment_method'] == 'Cash On Delivery') {
													echo $this->cart->total() - $this->cart->total() * 0.05;
												} else {

													echo $this->cart->total() - $this->cart->total() * 0.1;
												}
