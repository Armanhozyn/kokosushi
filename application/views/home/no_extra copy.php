<div class="row"> 
					...
					<div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <textarea onkeydown="noteChange(this)" onchange="noteChange(this)" name="item_note" class="form-control" id="itemNote" rows="2" cols="5"></textarea>
    ...
    <div class="col-md-6">
        ...
        <?php foreach ($sauce_list as $item): ?>
            ...
            <div class="form-check">
                ...
                <input name="sauce_" class="form-check-input" type="checkbox" value="<?php echo $item->sauce_id;  ?>" id="souce<?php echo $item->sauce_id;  ?>">

                <label class="form-check-label" for="souce<?php echo $item->sauce_id;  ?>">

                   <?php echo "{$item->display_code}) {$item->souce_name}"; ?>
