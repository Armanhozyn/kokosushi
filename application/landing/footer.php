...
<footer id="mad-footer" class="mad-footer style-3">
        ...
        <div class="container">
            <div class="row vr-size-1">
                ...
                <div class="col-md-4">
                    <!--================ Widget ================-->
                    <section class="mad-widget">
                        <a href="#" class="mad-logo content-element-3"><img src="<?php echo $asset_url; ?>images\logo3.png" alt=""></a>
                    ...
                    <section class="mad-widget">
                        ...
                        <div class="mad-vr-list">
                            <ul>
                                ...
                                <li><a href="#" class="mad-link">Events</a></li>
                                <li><a href="#" class="mad-link">Contact</a></li>
                                <li><a href="#" class="mad-link">News</a></li>
                                <li><a href="#" class="mad-link">Reservation</a></li>
                            </ul>
                        </div>
                    </section>
                    <!--================ End of Widget ================-->
    ...
    <!--================ End of Footer row ================-->
    <p class="copyrights">Copyright © <?php echo date('Y'); ?> <a href="#">SushiFushi</a>.
...
<script src="<?php echo $asset_url; ?>https://maps.google.com/maps/api/js?key=AIzaSyBAiQZmdiJv7g15ObEiISBGitvmdxWusc0&amp;libraries=geometry&amp;v=3.20"></script>
